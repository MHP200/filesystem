...
ADDOBJ= fsInit.o freespace.o volumecontrol.o directories.o parsepathintegration.o parsepathtokenization.o parsepathtraversal.o parsepathload.o fs_mkdir.o fs_getcwd.o fs_setcwd.o fs_rmdir.o fs_stat.o fs_isDir.o fs_isFile.o fs_delete.o fs_openrdclose.o b_io.o b_io_helper.o fs_move.o
ARCH = $(shell uname -m)
